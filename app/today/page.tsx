  ...
  return (
    <div className="p-10 max-w-4xl mx-auto">
      ...
      <div className="mb-8 pb-4">
        <h2 className="text-lg font-semibold text-white-700 mb-4">{formatDateHeading()}</h2>
        ...
        {showInput ? (
          ...
          <button
            ...
            className="flex items-center gap-2 text-red-500 hover:text-white group mt-2 mb-6"
          >
